...
<div style="width: 90px;">
   <?php if ($allow['update'] OR $allow['delete'] ): ?>
        ...
        <!--   <?php if ( $allow['read'] ): ?>
          ...
          <?php endif ?> -->
          <?php if ($allow['update']): ?>
            <a class="btn btn-default btn-xs edit" data-toggle="tooltip" data-placement="top" title="Просмотр / Редактирование"" href=<%= "orderdetails/"+id%>><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a>
          <?php endif ?>
...
<script type="text/template" id="tmpOrdHistoryRow">
<tr>
  <td><%=date%><td>
  <td><%=description%><td>
</tr>
