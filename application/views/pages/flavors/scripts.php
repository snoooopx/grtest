...
<!-- Flavor Edit Modal -->
<script type="text/template" id="tmplFlavorEditModal">
  <!-- Modal -->
  <div class="modal fade" id="mdlEditFlavor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
      <!-- .modal header -->
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="myModalLabel">Редактировать Вкус: <b><%= name %></b></h4>
        </div><!--/.modal header -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="flavorNameEdit">Название</label>
                <input type="text" class="form-control input-sm" id="flavorNameEdit" name="flavorNameEdit" placeholder="Название Вкуса *" required="required" value="<%= name %>" >
              </div>
            </div><!--/.col-md-6-->
              
            <div class="col-md-6">
              <div class="form-group">
                <label for="flavorNoteEdit">Описание</label>
                <input type="text" class="form-control input-sm" id="flavorNoteEdit" name="flavorNoteEdit" placeholder="Описание Вкуса" value="<%= description %>">
              </div>
            </div><!--/.col-md-6-->
        ...
        <div class="modal-footer">
          <button type="submit" name="sbmtFlavorEdit" id="sbmtFlavorEdit" class="btn btn-primary">Сохранить</button>
